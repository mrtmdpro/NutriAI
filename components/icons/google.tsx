// Google brand mark — colors are required brand assets, not themable.
// Per AGENTS.md, foundational colors must use tokens; brand marks are
// excepted because their hex values are dictated by the source brand.
